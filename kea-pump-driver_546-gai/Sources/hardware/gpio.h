...
#define AHI_SetOutput() (GPIOA_PDDR |= ((uint32)1<<16))//PTC0
#define AHI_ClrVal()    (GPIOA_PCOR |= ((uint32)1<<16))
#define AHI_SetVal()    (GPIOA_PSOR |= ((uint32)1<<16))
...
#define BHI_SetOutput() (GPIOA_PDDR |= ((uint32)1<<17))//PTC1
#define BHI_ClrVal()    (GPIOA_PCOR |= ((uint32)1<<17))
#define BHI_SetVal()    (GPIOA_PSOR |= ((uint32)1<<17))
...
#define REDLED_SetOutput() (GPIOA_PDDR |= ((uint32)1<<7))//PTA7
#define REDLED_ClrVal()    (GPIOA_PCOR |= ((uint32)1<<7))
#define REDLED_SetVal()    (GPIOA_PSOR |= ((uint32)1<<7))
#define REDLED_Toggle()    (GPIOA_PTOR |= ((uint32)1<<7))
